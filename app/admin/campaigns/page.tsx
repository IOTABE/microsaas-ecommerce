...
import { Send, Sparkles, CheckCircle2, AlertCircle, Smartphone } from 'lucide-react';
...
export default function AdminCampaignsPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      <div>
        <h1 className="text-2xl font-bold text-white">Alertas Promocionais & Campanhas</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 panel-solid p-6 space-y-5">
          <div className="flex items-center gap-2 border-b border-white/[0.07] pb-3">
            <Send className="w-5 h-5 text-blue-400" />
            <h2 className="font-bold text-white text-sm">Configuração da Campanha</h2>
          </div>

          {result && (
            <div className="p-4 bg-emerald-500/10 text-emerald-200 text-xs rounded-xl flex items-start gap-3 border border-emerald-400/25">
          ...
          {error && (
            <div className="p-3 bg-red-500/10 text-red-300 text-xs rounded-xl flex items-center gap-2 border border-red-400/25">
          ...
          <form onSubmit={handleSendCampaign} className="space-y-4">
            <div>
              <label className="field-label">Nome Interno da Campanha *</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="input-dark font-mono font-bold text-cyan-300"
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                <label className="field-label !mb-0">Mensagem Promocional *</label>
                <span className="text-[10px] text-slate-500">
                  Tags suportadas: <code className="text-cyan-300">&#123;&#123;nome&#125;&#125;</code>,{' '}
                  <code className="text-cyan-300">&#123;&#123;cupom&#125;&#125;</code>
                </span>
              </div>
              <textarea
                rows={4}
        ...
        <div className="panel-solid p-6 space-y-4">
          <div className="flex items-center gap-2 text-xs font-bold text-slate-200 border-b border-white/[0.07] pb-3">
            <Smartphone className="w-4 h-4 text-emerald-400" />
            <span>Pré-visualização (WhatsApp)</span>
          </div>

          <div className="bg-[#0b141a] p-4 rounded-2xl border border-white/[0.07] min-h-[260px] flex flex-col justify-end">
            <div className="bg-[#1f2c34] p-3.5 rounded-2xl rounded-bl-none shadow-sm max-w-xs space-y-2 text-xs text-slate-100">
              ...
              <div className="text-[9px] text-slate-500 text-right">11:15</div>
            </div>
          </div>

          <div className="p-3 bg-white/[0.03] rounded-xl border border-white/[0.06] text-[11px] text-slate-400 space-y-1">
            <strong className="block text-slate-200">Regras Anti-Spam & LGPD:</strong>
            <p>
